    ...
    <div class="container-fluid bg--primary">
        <div class="row pt-5">
            ...
            <div class="mb-3">
                ...
                <input type="email" require name="txtEmail" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                <small id="emailHelp" class="form-text text-muted"></small>
            </div>
            <div class="mb-3">
                <label for="exampleInputPassword1" class="form-label text-gray fs-14">Password (6 or more characters)</label>
                <input type="password" require minlength="6" name="txtPass" class="form-control" id="exampleInputPassword1">
                <small id="emailHelp" class="form-text text-muted"></small>
            </div>
