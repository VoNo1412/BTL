...
const displayPhoto = document.querySelector(".display_photo");
var upload_img = "";
...
function postUser() {
    ...
    const post = new Post_P1(img_user, profileName);
    let img = document.querySelector("#create-img");
    img.src= post.userImg;
    txtName.textContent = post.userName;
}
...
function loadingPost() {
    ...
    if(gallery !== "") {
        ...
        <div class="px-4 py-2" id="posted-desc">
            ${post.userContent}
            <div class="">
                <img src="${gallery}" alt="" class="display_photo">
            </div>
        </div>
