    ...
    <div class="row px-5 mt-3">
      ...
      <div class="col-md-3" style="max-width: 250px;">
        <div class="side-bar" style="border: 1px solid gray;border-radius: 10px ;overflow: hidden;  ">
          <a class="nav-link " style="color: #000000E6;" aria-current="page" href="#"><i class="bi bi-bookmark-fill"
              style="color: #666;"></i> My jobs</a>
          <a class="nav-link " style="color: #000000E6;" aria-current="page" href="#"><i class="bi bi-bell-fill"
              style="color: #666;"></i> Job Alerts</a>
          <a class="nav-link " style="color: #000000E6;" aria-current="page" href="#"><i class="bi bi-cash"
              style="color: #666;"></i> Salary</a>
          <a class="nav-link " style="color: #000000E6;" aria-current="page" href="#"><i class="bi bi-clipboard-check"
              style="color: #666;"></i> Skill Assessments</a>
          <a class="nav-link " style="color: #000000E6;" aria-current="page" href="#"><i
              class="bi bi-file-earmark-text-fill" style="color: #666;"></i> Interview Prep</a>
          <a class="nav-link " style="color: #000000E6;" aria-current="page" href="#"><i class="bi bi-file-earmark"
              style="color: #666;"></i> Resume Builder</a>
          <a class="nav-link " style="color: #000000E6;" aria-current="page" href="#"><i class="bi bi-youtube"
              style="color: #666;"></i> Job Seeker Guidance</a>
          <a class="nav-link " style="color: #000000E6;" aria-current="page" href="#"><i class="bi bi-gear-fill"
              style="color: #666;"></i></i> Application Settings</a>
        </div>
